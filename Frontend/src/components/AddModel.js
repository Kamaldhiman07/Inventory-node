...
export default function AddModel({ addModelModalSetting, handlePageUpdate }) {
  ...
  const addModel = () => {
    fetch("http://localhost:4000/api/model/add", {
      ...
      .then((data) => {
        ...
        setModel({ ...model, modelName: "" }); // Reset the modelName
      })
      .catch((error) => {
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full sm:max-w-lg">
              ...
              <div className="px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                ...
                <button
                  ...
                  onClick={() => {
                    addModelModalSetting();
                    setModel({ ...model, modelName: "" }); // Reset the modelName on cancel
                  }}
                  ref={cancelButtonRef}
                >
                  Cancel
